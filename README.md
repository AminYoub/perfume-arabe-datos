...
Fecha de las pirámides: 2026-09-07. Fecha de los agregados: 2026-09-12.
...
- Las **notas**, del bloque de pirámide (salida, corazón, fondo). 142 perfumes tienen pirámide. 8 no la tienen en Fragrantica, solo una lista plana, y así se marcan (`tiene_piramide = 0`); en esos la lista está en `notas` y los tres niveles van vacíos. 2 no tienen ninguna nota publicada.
...
- Almizcle aparece en el 52 % de las pirámides. Vainilla y ámbar, en el 42 %. Pachulí, 38 %; jazmín, 36 %; bergamota, 35 %.
...
- Amaderado es acorde en el 71 % de las fichas. Dulce, 63 %. Atalcado y ámbar, 61 %.
...
- Cada casa repite algo: Khadlaj pone neroli 5,3 veces más de lo que le tocaría por su tamaño; Afnan, manzana 3,5; French Avenue, madera de gaiac 3,3.

## Lo que esto no demuestra

Una pirámide es lo que la marca declara, no lo que hay en el frasco ni en qué cantidad. Dos perfumes con las mismas notas pueden oler distinto. Los precios de `datos.json` son los de nuestro catálogo, no una media del mercado. Y la muestra son nuestros 152 frascos, no el perfume árabe entero.
